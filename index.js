...
var finances = [
  ...
  for (var i = 0; i < finances.length; i++) {
      ...
      if (i > 0) {
          ...
          var monthlyChange = currentAmount - previousAmount;
          changeInProfits += monthlyChange;
  ...
  var averageChange = (changeInProfits / (totalMonths - 1)).toFixed(2); //<-- taken from w3school
